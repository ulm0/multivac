...
the reader's use of it, the scanner's use of it, and the named check. A
tombstone on the substring test was drafted and withdrawn on measurement: it
cannot fire, because the reverted line hides itself from every leg.
