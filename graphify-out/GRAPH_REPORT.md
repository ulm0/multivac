...
### Community 1 - "file.ts"
Cohesion: 0.14
Nodes (20): archiveChange(), ChangeClaim, ChangeError, ChangeFile, frontmatterError(), normalizeChange(), parseChange(), ParsedChange (+12 more)
...
### Community 6 - "init.ts"
Cohesion: 0.06
Nodes (43): detectAdapters(), Detected, ensureVisibleToGit(), exists(), Flags, init, isRepoRoot(), migrateLegacy() (+35 more)
...
Cohesion: 0.15
Nodes (14): changePath(), changesDir(), loadChange(), saveChange(), declare(), ctx, declare(), eco (+6 more)
...
Cohesion: 0.15
Nodes (41): runScaffold(), changeRel(), closeGate(), landingPlan(), anchoredClaimIds(), baseNames(), blockedPaths(), BranchBase (+33 more)
...
Cohesion: 0.14
Nodes (29): brainAtChannel(), brainDrift(), Diagnostic, enactmentLine(), evaluateCore(), EvaluateOpts, findStaleMount(), finishedChanges() (+21 more)
...
Cohesion: 0.17
Nodes (13): ClaimRow, collectBrainAnchors(), nibble(), parseAnchors(), parseClaimRows(), readClaimRows(), ESCAPE_HINTS, POSIX_CLASSES (+5 more)
...
Cohesion: 0.15
Nodes (22): evalLeg(), evaluateAnchors(), EvaluateOptions, RANK, RepoHandle, rewriteGlob(), TaggedMatch, Target (+14 more)

### Community 113 - "fixture.ts"
Cohesion: 0.05
Nodes (50): deployStacks(), nameSome(), openQuestions(), runSeed(), seed, verify, lsFiles(), unmergedFiles() (+42 more)

### Community 114 - "count.ts"
Cohesion: 0.21
Nodes (7): count, USAGE, findMount(), realPath(), samePath(), CommandContext, eco()
...
Cohesion: 0.21
Nodes (11): ParseDiagnostic, ParseResult, Evaluated, Anchor, ClaimResult, Config, Exclusion, LegResult (+3 more)
...
### Community 121 - "ritual.test.ts"
Cohesion: 0.19
Nodes (8): scaffoldChange(), change, ritualChecklist(), blockWorktree(), brainWithStaleRemote(), git(), wt(), landedChange()
...
### Community 140 - "git.ts"
Cohesion: 0.22
Nodes (8): AMBIENT_GIT_ENV, cleanEnv(), currentBranch(), execFileP, headSha(), remoteTrackingRef(), untrackedFiles(), eco

### Community 142 - "change.test.ts"
Cohesion: 0.29
...
- **Why does `makeScratchEcosystem()` connect `fixture.ts` to `init.ts`, `git.ts`, `change.test.ts`, `count.ts`, `doors.ts`, `loadChange`, `ritual.test.ts`, `registry.ts`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
